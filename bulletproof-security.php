...
<?php
		...
		echo '</a>';
?>
<h3><?php _e('Current General .htaccess Status '); ?><a href="http://www.ait-pro.com/aitpro-blog/bulletproof-security-plugin-support/bulletproof-security-support/" target="_blank" onmouseover="Tip('If you already have an existing .htaccess file or files be sure to download them via FTP as a backup. If you have customized your current  .htaccess file(s) with your own code then just add your custom code to your BulletProof .htaccess files.<br><br>A Green font color message indicates a file IS present or INFORMATION.  A Red font color message indicates a file IS NOT present, an ERROR message or WARNING.', WIDTH, 400, PADDING, 8, ABOVE, true, FADEIN, 400, FADEOUT, 300)" onmouseout="UnTip()">Read Me!</a></h3>
...
<h4><?php _e('BulletProof .htaccess Master File Check '); ?><a href="http://www.ait-pro.com/aitpro-blog/bulletproof-security-plugin-support/bulletproof-security-support/" target="_blank" onmouseover="Tip('Just a quick check to verify that the required files are in your BulletProof Plugin folder. The BulletProof Security folder location for the .htaccess files listed below is /wp-content/plugins/bulletproof-security/htaccess/.', WIDTH, 400, PADDING, 8, ABOVE, true, FADEIN, 400, FADEOUT, 300)" onmouseout="UnTip()">Read Me!</a></h4>
