...
<?php if (isset($_POST['submit'])) { // Form Submit Notifications and Messages
	...
	_e('<font color="red"><strong>Warning: </strong></font>Maintenance Mode Is Activated. Your website is now displaying the Website Under Maintenance page to all visitors. To exit or turn off Maintenance mode activate either the Root Folder Default Mode or BulletProof Security Mode. You must update your Permalink Settings to be able log in and out of your website while in Maintenance Mode. Click this <a href="options-permalink.php" target="_blank">Permalinks Settings link</a> to open the Permalinks Settings page, click the Save Changes button and close the Permalinks Settings window. You should now be able to log in and out of your website.');	
	}
...
<h3><?php _e('<font color="red"><strong>CAUTION: </strong></font>'); ?><a href="http://www.ait-pro.com/aitpro-blog/1166/bulletproof-security-plugin-support/bulletproof-security-plugin-guide-bps-version-45/#maintenance-mode-ip-instructions" target="_blank" onmouseover="Tip('When you activate Maintenance Mode your website will be put in HTTP 503 Service Temporarily Unavailable status and display a Website Under Maintenance page to visitors. You must add your public IP address to the BPS maintenance.htaccess master file first before you activate Maintenance mode in order to view your website while everyone else sees the Website Under Maintenance page. Your Public IP address is shown below in the green box. Your Public IP address may change frequently so be sure to check that the IP address shown here matches the IP address contained in the maintenance.htaccess file before activating Maintenance Mode.<br><br><strong>In order for you to log in and out of your website while in Maintenance Mode you must update your Permalinks Settings right after you have activated Maintenance Mode. When you activate Maintenance Mode you will see a Warning message displayed with simple instructions and the link to the Permalinks Settings page.</strong><br><br>Your SERPs (website or web page ranking) will not be affected by putting your website in Maintenance Mode for up to several days for existing websites. As long as you add your IP Address to the maintenance.htaccess master file and activated it you can continue to work on your website as you normally would while everyone else is sent to your Website Under Maintenance page.<br><br>If you are unable to log back into your Dashboard or you are also seeing the Website Under Maintenance page then you will need to FTP to your website, download the .htaccess file in your root folder and add your correct IP address.  If this does not let you back into your website then there is an incorrect path setting in your .htaccess file. <br><br>For more specific information and detailed instructions click this Read Me button link to view the <strong>BulletProof Security Guide.</strong>', WIDTH, 550, PADDING, 8, ABOVE, true, FADEIN, 400, FADEOUT, 300)" onmouseout="UnTip()"><strong>Read Me</strong></a></h3>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="help_faq_table">
  ...
  <tr>
    <td class="table_cell_help"><a href="http://www.ait-pro.com/aitpro-blog/1166/bulletproof-security-plugin-support/bulletproof-security-plugin-guide-bps-version-45/" target="_blank">BPS .45.2 Guide</a></td>
  ...
  <tr>
    <td class="table_cell_help"><a href="http://www.ait-pro.com/aitpro-blog/1166/bulletproof-security-plugin-support/bulletproof-security-plugin-guide-bps-version-45/#bps-45-new-features" target="_blank">BPS .45.2 Features</a></td>
    <td class="table_cell_help"><a href="http://www.ait-pro.com/aitpro-blog/1166/bulletproof-security-plugin-support/bulletproof-security-plugin-guide-bps-version-45/#bps-advanced-coding-modfications" target="_blank">BPS .45.2 Coding Modifications Help Info</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="table_cell_help"><a href="http://www.ait-pro.com/aitpro-blog/1183/bulletproof-security-plugin-support/bulletproof-security-plugin-bps-version-45-screenshots/" target="_blank">BPS .45.2 Screenshots</a></td>
