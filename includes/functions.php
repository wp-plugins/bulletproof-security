...
// Get contents of Root .htaccess file from 3-45 - if "7" found in string position 17 - offset 16 - good - else bad
...
function root_htaccess_status() {
	...
	$check_string = @strpos($section, "7", 16);
