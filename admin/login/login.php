...
<?php if ( esc_html($_SERVER['REQUEST_METHOD']) == 'POST' && ! isset( $_POST['Submit-Login-Security-search'] ) || @$_GET['settings-updated'] == true ) { ?>
...
<?php
	...
	echo '<form name="LoginSecuritySearchForm" action="admin.php?page=bulletproof-security/admin/login/login.php#LSM-DB-Table" method="post">';
...
<form name="bpsLSMExport" action="admin.php?page=bulletproof-security/admin/login/login.php" method="post">
