...
<form name="LoginSecurityOptions" action="options.php" method="post">
    ...
    <label for="LSLog" style="margin:0px 26px 0px 0px;"><strong><?php _e('Max Login Attempts:', 'bulletproof-security'); ?></strong></label>
    <input type="text" name="bulletproof_security_options_login_security[bps_max_logins]" class="regular-text-50-fixed" style="width:50px;" value="<?php if ($BPSoptions['bps_max_logins'] != '') { echo $BPSoptions['bps_max_logins']; } else { echo '3'; } ?>" /><br />
    <label for="LSLog" style="margin:0px 1px 0px 0px;"><strong><?php _e('Automatic Lockout Time:', 'bulletproof-security'); ?></strong></label>
    <input type="text" name="bulletproof_security_options_login_security[bps_lockout_duration]" class="regular-text-50-fixed" style="width:50px;" value="<?php if ($BPSoptions['bps_lockout_duration'] != '') { echo $BPSoptions['bps_lockout_duration']; } else { echo '60'; } ?>" /><label for="LSLog" style="margin:0px 0px 0px 5px;"><strong><?php _e('Minutes', 'bulletproof-security'); ?></strong></label><br />
    <label for="LSLog" style="margin:0px 18px 0px 0px;"><strong><?php _e('Manual Lockout Time:', 'bulletproof-security'); ?></strong></label>
    <input type="text" name="bulletproof_security_options_login_security[bps_manual_lockout_duration]" class="regular-text-50-fixed" style="width:50px;" value="<?php if ($BPSoptions['bps_manual_lockout_duration'] != '') { echo $BPSoptions['bps_manual_lockout_duration']; } else { echo '60'; } ?>" /><label for="LSLog" style="margin:0px 0px 0px 5px;"><strong><?php _e('Minutes', 'bulletproof-security'); ?></strong></label><br />
...
<strong><label for="bps-monitor-email" style="margin:0px 15px 0px 0px;vertical-align:middle;"><?php _e('Send Email Alerts & Log Files To:', 'bulletproof-security'); ?> </label></strong>
...
<strong><label for="bps-monitor-email" style="margin:0px 0px 0px 0px;vertical-align:middle;"><?php _e('Send Email Alerts & Log Files From:', 'bulletproof-security'); ?> </label></strong>
...
<strong><label for="bps-monitor-email" style="margin:0px 14px 0px 0px;vertical-align:middle;"><?php _e('Send Email Alerts & Log Files Cc:', 'bulletproof-security'); ?> </label></strong>
...
<strong><label for="bps-monitor-email" style="margin:0px 8px 0px 0px;vertical-align:middle;"><?php _e('Send Email Alerts & Log Files Bcc:', 'bulletproof-security'); ?> </label></strong>
...
<strong><label for="bps-monitor-email" style="margin:0px 0px 0px 0px;"><?php _e('Login Security: Send Login Security Email Alert When...', 'bulletproof-security'); ?></label></strong><br />
