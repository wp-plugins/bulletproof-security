...
<strong><label for="bps-CCode"><?php $text = '<font color="blue">'.__('This Custom Code text box is for optional/Bonus code. To get this code click the link below:', 'bulletproof-security').'<br><a href="http://forum.ait-pro.com/forums/topic/protect-login-page-from-brute-force-login-attacks/" title="Link opens in a new Browser window" target="_blank" style="font-size:11px;">Brute Force Login Page Protection Code</a></font>'; echo $text ; ?> </label></strong><br />
...
<strong><label for="bps-CCode"><?php $text = '<font color="blue">'.__('Add one pound sign # below to prevent the WP-ADMIN/INCLUDES section of code from being created in your root .htaccess file', 'bulletproof-security').'</font>'; echo $text ; ?> </label></strong><br />
